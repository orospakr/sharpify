...
namespace ShopifyAPIAdapterLibrary.Tests
{
	...
	public class ShopifyAuthorizerTest
	{
		...
		public void ShouldCreateAuthorizationURL ()
		{
			...
			Assert.AreEqual("http://atkinson-cafe.myshopify.com/admin/oauth/authorize?client_id=apikey&scope=dsafsaf&redirect_uri=http%3a%2f%2fwww.google.com", sa.GetAuthorizationURL(new string[] { "dsafsaf" }, "http://www.google.com"));
		}
	}
}
